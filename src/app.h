...
typedef enum
{
    ...
    APP_STATE_INIT=0,
     /* antes de loop una sola vez se ejecuta*/        
    APP_STATE_PRELOOP,
...
typedef struct
{
    ...
    /* Number of bytes read from Host */ 
    //uint32_t numBytesRead; 
    bool bufferHasBeenReadByClient;                      /* Delays subsequent read operations until the client clears the buffer */
    
    size_t readBufferCharCount;                          /* Number of characters read */
    
    /* TODO: Define UART variable used by the application. */
